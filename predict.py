...
# def load_label():
#     listfile=[]
#     with open("/content/drive/MyDrive/BE_PROJECT/be-project/sign-rnn-mediapipe/label-12-03-2021.txt",mode='r') as l:
...
#     new_model = tf.keras.models.load_model('/content/drive/MyDrive/BE_PROJECT/be-project/sign-rnn-mediapipe/model-12-03-2021.h5')
#     #new_model.summary()
...
#     main("/content/drive/MyDrive/BE_PROJECT/be-project/sign-rnn-mediapipe/output/Absolute/")
